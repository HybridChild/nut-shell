...
### Fixed
- Strip trailing `\r\n` in indented response to avoid blank final line
...
[Unreleased]: https://github.com/HybridChild/nut-shell/compare/v0.1.2...HEAD
[0.1.2]: https://github.com/HybridChild/nut-shell/compare/v0.1.1...v0.1.2
